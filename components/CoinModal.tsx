...
const CoinModal: React.FC<CoinModalProps> = ({ isOpen, onClose, currentCoins }) => {
  const handleShare = async () => {
    ...
    try {
      ...
      coinService.addCoins(2); // Give 2 coins for sharing
  ...
  const handleRecharge = () => {
    ...
    const whatsappUrl = `https://wa.me/8801400893882?text=${encodeURIComponent(message)}`;
